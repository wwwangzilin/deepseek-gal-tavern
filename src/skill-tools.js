...
;(function () {
  ...
  function toolSchemasBlock() {
    return [
      '## Tools',
      'You have access to a set of tools to help answer the user\'s question or enhance the roleplay. You can invoke tools by writing a XML block with the tool name and JSON payload:',
      '',
      '<memory_save>{"type": "topic", "name": "标题", "content": "要保存的内容", "tags": ["标签"]}</memory_save>',
      '',
      '<character_learn>{"field": "personality", "content": "新学到的性格细节"}</character_learn>',
      '',
      '### Available Tool Schemas',
      MEMORY_SAVE_SCHEMA,
      CHARACTER_LEARN_SCHEMA,
      '',
      '## 工具使用规则',
